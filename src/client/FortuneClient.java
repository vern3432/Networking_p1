...
public class FortuneClient extends JFrame {
    ...
    public FortuneClient() {
        ...
        JLabel messageLabel = new JLabel("Write a short message:");
        ...
        optionsComboBox = new JComboBox<>(new String[]{"Random", "Random by Author"});
        ...
        sendTypeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                sendType();
            }
        });
